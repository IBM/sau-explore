...
class JesterDataBandit(DataBasedBandit):
    """A contextual bandit based on the `Jester Online Joke Recommender`.

    Source:
        http://eigentaste.berkeley.edu/dataset/

    Citation:
        Goldberg, Roeder, Gupta, and Perkins. Eigentaste: A constant timecollaborative filtering algorithm.Information Retrieval, 4(2):133–151, 2001
